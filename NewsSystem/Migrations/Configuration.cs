namespace NewsSystem.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<NewsSystem.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(NewsSystem.Models.ApplicationDbContext context)
        {
            ...
            context.Articles.AddOrUpdate(this.Articles.ToArray());
        }
    }
}
